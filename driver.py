...
# This section does not work. Would need to run using ipython notebook I guess.
...
# the second last number is each row is the score of the overall configuration
...
# delete some rows of subset which had few parts occur
deleteIdx = []
